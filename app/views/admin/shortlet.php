...
<title><?= SITENAME ?> | Short-Let</title>
<style>
   span.badge {
         ...
         <div class="">
            <div class="col-lg-12">
               ...
               <div class="d-flex align-items-center justify-content-between">
                  <h4 class="text-uppercase">Short-Let Rooms</h4>
               ...
               <div class="card shadow-sm border-0 mb-3 ">
                  <div class="card-header py-1">
                     ...
                     <button class="btn text-bg-warning btn- rounded-0 border-0 shadow-none d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#room-short"><i class="las la-plus fs-6"></i> Add Room</button>
                  </div>
                  <div class="card-body">
                        ...
                        <table class="table table-hover text-center sticky-top" id="myTable">
                           ...
                           <tbody>
                              <?php if ($data['getRooms'] <= 0) : ?>
                                 <tr>
                                    <th scope="row" colspan="8" class="text-center">Short-Let Room is empty</th>
                                 </tr>
                              <?php else : ?>
