  ...
  <section class="facilities my-5 p3-5">
    <div class="container">
      <?php if (isset($_GET['msg']) && $_GET['msg'] == '1') : ?>
        <?php flash_msg('msg') ?>
      <?php endif; ?>
      <h2 class="text-center text-uppercase">Our Rooms</h2>
              ...
              <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                <div class="border bg-light p-3 rounded-0 mb-3">
                  ...
                  <form method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="btn_filter_rooms" class="btn btn-custom-bg btn-sm form-control shadow-none rounded-0 mt-2">Search</button>
                  </form>
                </div>
              </div>
            </div>
                ...
                <div class="card mb-3 border-0 shadow">
                  <div class="row g-0 p-3 align-items-center">
                    ...
                    <div class="col-md-2">
                      ...
                      <?php else : ?>
                        <a href="<?= URLROOT ?>/confirmbooking/<?= $row->room_id ?>" class="btn btn-custom-bg btn-sm shadow-none mb-2 w-100">Select Room</a>
                      <?php endif; ?>
